...
async function h5Req(_0x435d5d, _0x5231fc) {
    ...
    const _0x3d0021 = getToken(_0x435d5d),
          ...
          _0x4c2b9e =md5(_0x15dbe5 + '&' + _0x395caf + '&' + _0xc3123 + '&' + JSON.stringify(_0x5231fc));
    _0xb036ce = {
        url: "https://shopping.ele.me/h5/mtop.koubei.interactioncenter.platform.right.lottery/1.0/?jsv=2.6.1&appKey=12574478&t=" + _0x395caf + "&sign=" + _0x4c2b9e + "&api=mtop.koubei.interactioncenter.platform.right.lottery&v=1.0&type=originaljson&dataType=json",
        method: "POST",
        headers: _0x9519bd,
        body: _0x262d46
    };
...
async function _0x12d072() {
    ...
    for (let _0x5c83c6 = 0; _0x5c83c6 < _0x1b7a0a.length; _0x5c83c6++) {
        ...
        const _0x324e0d = _0x2dd844.user_id;
        let _0x5e3540 = _0x2dd844.mobile;
